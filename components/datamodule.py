...
from components.collation import get_text_token_collater
from components.dataset import SpeechSynthesisDataset
from components.fbank import get_fbank_extractor
from components.input_strategies import PromptedPrecomputedFeatures
...
class TtsDataModule:
    ...
    def train_dataloaders(
        ...
        if self.args.on_the_fly_feats:
            ...
            # remove it from components prep stage.
