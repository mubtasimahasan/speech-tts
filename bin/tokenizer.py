...
from components import (
    ...
    STAudioTokenConfig,
    AudioTokenExtractor,
    STAudioTokenExtractor,
    TextTokenizer,
    tokenize_text,
)
from components.fbank import get_fbank_extractor
...
def main():
    ...
    if args.audio_extractor:
        ...
        if args.audio_extractor == "speechtokenizer":
            audio_extractor = STAudioTokenExtractor(args.ckpt_dir, STAudioTokenConfig())
        else:
        ...
        for partition, m in manifests.items():
            ...
            if args.audio_extractor:
                if args.audio_extractor == "Encodec":
                    ...
                    storage_path = (
                        f"{args.output_dir}/{args.prefix}_speechtokenizer_{partition}"
                    )
                else:
                    storage_path = (
                ...
                with torch.no_grad():
                    if (
                        ...
                        and (args.audio_extractor == "Encodec" or args.audio_extractor == "speechtokenizer")
                    ):
